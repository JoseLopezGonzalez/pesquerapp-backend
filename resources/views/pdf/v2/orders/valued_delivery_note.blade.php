    ...
    <div class="max-w-[210mm] mx-auto p-6 bg-white rounded min-h-screen">
        ...
        <div class="flex justify-between items-end mb-6">
            ...
            <div class="flex items-start gap-4">
                <div class="text-end">
                    <h2 class="text-lg font-bold">Albarán Valorado</h2>
        ...
        <div class="mt-6 p-4 bg-gray-50 rounded-lg border">
            <p class="text-xs italic">
                Este documento no es una factura. Documento valorado de entrega y confirmación de precios y cantidades.
            </p>
        </div>
    </div>
</body>
