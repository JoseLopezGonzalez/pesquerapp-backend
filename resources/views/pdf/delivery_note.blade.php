            ...
            <table class="w-full text-sm">
                ...
                <tbody class="border-b-2 border-black">
                    @foreach($order->productsBySpeciesAndCaptureZone as $productsBySpeciesAndCaptureZone)
                        ...
                        <tr class="border-b border-gray-200" >
                            <th class="text-left font-light italic  p-1.5" style="font-size:0.60rem; line-height:100%" >{{ $productsBySpeciesAndCaptureZone['species']->scientific_name.'('. $productsBySpeciesAndCaptureZone['species']->fao.')'.' - '.$productsBySpeciesAndCaptureZone['captureZone']->name .' - '.$productsBySpeciesAndCaptureZone['species']->fishing_gear->name }}</th>
