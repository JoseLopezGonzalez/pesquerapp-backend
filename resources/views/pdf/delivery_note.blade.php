            ...
            <table class="w-full text-sm">
                ...
                <tbody>
                    @foreach($order->productsBySpeciesAndCaptureZone as $productsBySpeciesAndCaptureZone)
                        ...
                        <tr class="border-b border-gray-200" >
                            <th class="text-left font-light italic  p-1.5" style="font-size:0.12rem" >{{ $productsBySpeciesAndCaptureZone['species']->scientific_name.'('. $productsBySpeciesAndCaptureZone['species']->fao.')'.' - '.$productsBySpeciesAndCaptureZone['captureZone']->name }}</th>
