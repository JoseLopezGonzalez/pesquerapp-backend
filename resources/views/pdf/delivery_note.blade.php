            ...
            <table class="w-full text-sm">
                ...
                <tbody>
                    @foreach($order->productsBySpeciesAndCaptureZone as $productsBySpeciesAndCaptureZone)
                        ...
                        <tr class="border-b border-gray-200" >
                            <th class="text-left font-light text-xs italic  p-1.5" >{{ $productsBySpeciesAndCaptureZone['species']->scientific_name.'('. $productsBySpeciesAndCaptureZone['species']->fao.')'.' - '.$productsBySpeciesAndCaptureZone['captureZone']->name }}</th>
