        ...
        @foreach ($imgs as $index => $img)
            <div class="imprimir  h-screen ">
                <div class="text-center text-uppercase h-full" style="position: relative;">
                    ...
                    <p style="text-align: left; font-size: 9pt; left: 187px; top: 460px; position: absolute;">
                        {{ $order->totals['boxes'] }} 
                    </p>
                    <p style="text-align: left; font-size: 9pt; left: 280px; top: 460px; position: absolute;">
                        cajas
                    </p>
                    <p style="font-size:5px text-align: left; font-size: 9pt; left: 350px; top: 460px; position: absolute;">
